...
public class BookImageImpl implements BookImage {
    ...
    protected void init() {
        if(StringUtils.isNotBlank(fileReference)) {
            ...
            if(assetResource != null) {
                imageAsset = assetResource.adaptTo(Asset.class);
            }
        }
    }
    ...
    public String getSrc() {
        return imageAsset == null ? StringUtils.EMPTY : imageAsset.getPath();
    }

    @Override
    public String getAlt() {
        return imageAsset == null ? StringUtils.EMPTY : imageAsset.getMetadataValueFromJcr(IMAGE_TITLE);
    }
}
